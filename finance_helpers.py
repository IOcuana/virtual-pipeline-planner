...
def compute_levelized_metrics_for_scenario(
    ...
    # If the Costs tab has already computed a total including tyres, use it
    trk_maint_year = float(st.session_state.get("trk_maint_year_calc", trk_maint_year))
    ...
    # Ditto for trailers
    trl_maint_year = float(st.session_state.get("trl_maint_year_calc", trl_maint_year))
